...
module Faster
  module Generators
    class PasswordControllerGenerator < Rails::Generators::NamedBase
...
CODE
      ...
      def create_controller_file
        template 'passwords_controller.rb', File.join("app/controllers", controller_class_path, "#{controller_file_name}_controller.rb")
      end
...
CODE
      ...
      def create_rswag_request_file
        template 'password_spec.rb', File.join('spec', 'requests', "#{controller_path}_spec.rb")
      end
