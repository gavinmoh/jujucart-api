...
module Faster
  module Generators
    class AccountControllerGenerator < Rails::Generators::NamedBase
...
CODE
      ...
      def create_controller_file
        template 'accounts_controller.rb', File.join("app/controllers", controller_class_path, "#{controller_file_name}_controller.rb")
      end
      ...
      def add_routes
        route "resource :accounts, only: [:show, :update]", namespace: regular_class_path
      end
       
      def create_rswag_request_file
        template 'account_spec.rb', File.join('spec', 'requests', "#{controller_path}_spec.rb")
      end
